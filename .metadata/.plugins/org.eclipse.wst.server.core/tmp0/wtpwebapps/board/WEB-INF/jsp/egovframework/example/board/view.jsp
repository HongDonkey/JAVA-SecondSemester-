...
<div class="container">
		...
		<div class="panel-body">
			<form class="form-horizontal" method="post" action="/">
				...
				<div class="form-group">
					...
					<div class="col-sm-10 control-label" style="text-align: left;">
					<c:out value="${boardVO.writerNm } / ${fn:substring(boardVO.indate, 0, fn:length(boardVO.indate)-2) }"/>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="pwd">내용:</label>
					<div class="col-sm-10 control-label" style="text-align: left;">
					<c:out value="${fn:replace(boardVO.contents, crcr, br) }" escapeXml="false"/>
					</div>
				</div>
			</form>
		</div>
	...
	<c:forEach var="result" items="${resultList }" varStatus="status">
		<div class="well well-sm">
			...
			<fmt:formatDate value="${result.indate }" pattern="yyyy-MM-dd hh:mm:ss"/><br/>
				...
				<div class="col-sm-10 control-label" style="text-align: left;">
					<input type="text" class="form-control" id="writer" name="writer"
 					...
 					<input type="text"
						...
						style="float: left; width: 40%" value="${fn:substring(boardVO.indate, 0, fn:length(boardVO.indate)-2) }">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="pwd">내용:</label>
