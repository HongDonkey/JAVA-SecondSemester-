...
//			throw processException("info.nodata.msg");
	...
	@Override
	public void addMember(BoardVO vo) throws Exception {
		boardDAO.addMember(vo);
	}

	@Override
	public int searchIDcheck(BoardVO vo) throws Exception {
		return boardDAO.searchIDcheck(vo);
	}
